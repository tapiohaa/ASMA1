...
### ### ### ### ### ### ### ### ### ### ### ### ### #
### ### ### ### ### ### ### ### ### ### ### ### ### #
###         r-script 2_analysis_data_set3.R       ###
###                Replication file               ###        
...
# Content: Create datasets for supplementary analyses. We focus on a subset
...
#panel = "W:/ASMA1/data/intermediate/id_date_panels/analysis_set3_id_yearAA_genderB.rds" # where AA in 11:18 and B in 1:2

# Outputs:
output_local_pol = "W:/ASMA1/data/cleaned/data3_local_pol.rds"
output_parametric = "W:/ASMA1/data/cleaned/data3_parametric.rds"
output_local_rand = "W:/ASMA1/data/cleaned/data3_local_rand.rds"
