...
output_rd1_table_2015 = "W:/ASMA1/analysis/tables/rd1_locpol_table_2015"
...
### ### ### ### ### ### ### ### ### ### ### ### ### 
#### 6) Effects using data from 2015-2019. ####
### ### ### ### ### ### ### ### ### ### ### ### ###

# List all the models that will be estimated:
models = mods(start_year=2015, outcome='gp_visits_ann')

# Estimate and save:
results.2015 = rdd_results(df.1, models)
rd.tables(results.2015, donut=0, output = output_rd1_table_2015)
